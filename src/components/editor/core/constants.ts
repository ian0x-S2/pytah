...
export const DEFAULT_EDITOR_MARKDOWN = [
  ...
  "| Math equations | `$ equation $` or `/math` | Ready |",
  "",
  "## KaTeX Math Equations",
  "",
  "Full TeX math support with inline formulas like $E = mc^2$ and block equations:",
  "",
  "$$",
  "\\int_{-\\infty}^{\\infty} e^{-x^2} dx = \\sqrt{\\pi}",
  "$$",
  "",
  "Click any equation to open the popover editor and modify the TeX expression in real time.",
  "",
  "## Images",
  "",
